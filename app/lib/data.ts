...
export const mySkills: Skill[]  = [
    ...
    { name: 'React', level: 75, type: 'framework' },
    { name: 'Next.js', level: 66, type: 'framework' },
    { name: 'Node.js', level: 100, type: 'runtime' },
    { name: 'Vue.js', level: 100, type: 'framework' },
    { name: 'HTML', level: 100, type: 'language' },
    { name: 'CSS', level: 100, type: 'language' },
    { name: 'Git', level: 100, type: 'tool' },
    { name: 'Docker', level: 66, type: 'tool' },
    { name: 'SQL', level: 66, type: 'language' },
    { name: 'NoSQL', level: 50, type: 'language' },
    { name: 'Angular', level: 75, type: 'framework' },
    { name: 'Java', level: 25, type: 'language' },
    { name: 'Nuxt.js', level: 80, type: 'framework' },
    { name: 'C#', level: 25, type: 'language' },
    { name: 'Rust', level: 33, type: 'language' },
    { name: 'Express.js', level: 75, type: 'framework' },
    { name: 'Nginx', level: 50, type: 'tool' },
];
